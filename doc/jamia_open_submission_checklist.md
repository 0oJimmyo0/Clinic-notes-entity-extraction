...
- [ ] **Original investigators:** complete the [PHI-free artifact/batch exposure attestations](investigator_exposure_attestation_template.md) using the [aggregate exposure-resolution worklist](exposure_resolution_worklist.md), including off-file viewing and whether notes/predictions informed aliases, rules, prompts, thresholds, or interpretation. Keep patient-level exceptions and source IDs in restricted storage.
